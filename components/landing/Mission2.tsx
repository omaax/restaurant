...
const Mission2 = () => {
  return (
    <div className='bg-[#e5e5e5]'>
        ...
        <Image className="h-70 w-80 md:h-[650px] md:w-[1000px] absolute m-10 mr-100 left-0 md:left-[20%]" width={800} height={800} src="/mission2.jpg" alt="mission" />
          <div className="w-[300px] md:w-[590px] h-[500xp] md:h-[440px] bg-white shadow-2xl shadow-gray-900 top-[60%] md:top-[80%] left-[10%] absolute">
              <div className="m-10">
