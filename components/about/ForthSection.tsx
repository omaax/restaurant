...
const ForthSection = () => {
  return (
    <div className='bg-[#e5e5e5] pt-100 sm:pt-70'>
        <div className="flex items-center justify-center text-center">
            <h1 className="font-bold text-4xl sm:text-6xl w-100 sm:w-250 mb-10 font-sans">We bake fresh, handmade bread, pastries and cakes every day</h1>
        </div>
        ...
        {/* IMAGE */}
            ...
            {/* ICONS */}
            <div className="grid grid-cols-1 md:grid-cols-2 my-10 w-[400px] md:w-[600px] ">
